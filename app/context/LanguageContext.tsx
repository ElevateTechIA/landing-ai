...
const translations = {
  en: {
    ...
    socialMedia: {
      ...
      compose: {
        title: 'Compose Post',
        textPlaceholder: 'What do you want to share?',
        hashtagPlaceholder: 'Add a hashtag and press Enter',
      ...
      whatsapp: {
        ...
        contacts: 'Contacts',
        noContacts: 'No contacts imported yet.',
      },
      settings: {
        title: 'Settings',
        language: 'Language',
  ...
  es: {
    ...
    socialMedia: {
      ...
      compose: {
        title: 'Componer Post',
        textPlaceholder: '¿Qué quieres compartir?',
        hashtagPlaceholder: 'Agrega un hashtag y presiona Enter',
        addHashtags: 'Hashtags',
        selectNetworks: 'Seleccionar redes',
      ...
      whatsapp: {
        ...
        noTemplates: 'No hay plantillas configuradas aún.',
        contacts: 'Contactos',
        noContacts: 'No hay contactos importados aún.',
      },
      settings: {
        title: 'Configuración',
        language: 'Idioma',
